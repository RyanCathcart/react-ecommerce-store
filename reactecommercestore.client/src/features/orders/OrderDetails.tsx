...
import { currencyFormat, formatOrderAddressString, formatOrderPaymentString } from "../../app/util/util";
import { useFetchOrderDetailsQuery } from "./orderApi";

export default function OrderDetails() {
  const { id } = useParams();
  const { data: order, isLoading } = useFetchOrderDetailsQuery(parseInt(id!));
  ...
  return (
    <Card sx={{ p:5, maxWidth: "md", mx: "auto" }}>
      ...
      <Box>
        ...
        <Box component="dl">
          ...
          <Typography component="dd" variant="body2" fontWeight="300">
            {formatOrderAddressString(order.shippingAddress)}
          </Typography>
        </Box>
        ...
        <Box component="dl">
          ...
          <Typography component="dd" variant="body2" fontWeight="300">
            {formatOrderPaymentString(order.paymentSummary)}
          </Typography>
        </Box>
      </Box>
